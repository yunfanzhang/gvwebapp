...
# -*- coding: utf-8 -*-
"""
@author: shaown@eryue.me
@date: Fri Oct 24 17:54:20 2014
...
class Session(object):
    def __init__(self, session_store, sessionid=None):
        ...
        self._sessionid = sessionid if sessionid else \
            self._store.generate_sid()
    ...
    def lass_access(self):
        access_info = self._store.get_session(self._sessionid,
                                              'last_access')
